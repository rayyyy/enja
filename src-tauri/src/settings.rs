...
pub struct VoiceSettings {
    ...
    #[serde(default = "default_true")]
    pub screen_context_ocr_enabled: bool,
...
impl Default for VoiceSettings {
    fn default() -> Self {
        Self {
            ...
            screen_context_ocr_enabled: true,
...
mod tests {
    ...
    fn defaults_use_nested_settings_contract() {
        ...
        assert!(settings.voice.screen_context_enabled);
        assert!(settings.voice.screen_context_ocr_enabled);
